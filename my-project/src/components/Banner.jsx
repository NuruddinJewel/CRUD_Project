...
// const Banner = () => {
//     return (
//         <div className="bg-[url('/assets/banner.png')] text-white  flex justify-between flex-col items-center  gap-5 h-[600px] bg-cover bg-center">
...
const Banner = () => {
    return (
        <div
            ...
            className="text-white flex justify-between flex-col items-center gap-5 h-[600px]"
        >
            <div className="p-10 text-center flex justify-center flex-col items-center gap-3.5 flex-1">
                <h1 className="text-7xl">
                    Discover Your <br /> Next Adventure
